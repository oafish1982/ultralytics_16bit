...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels):
        ...
        for i in range(3):
            ...
            # Place img in img3
            if i == 0:  # center
                img3 = np.full((s * 3, s * 3, img.shape[2]), 114, dtype=np.float32)  # base image with 3 tiles
                h0, w0 = h, w
    ...
    def _mosaic4(self, labels):
        ...
        for i in range(4):
            ...
            # Place img in img4
            if i == 0:  # top left
                img4 = np.full((s * 2, s * 2, img.shape[2]), 114.0, dtype=np.float32)  # base image with 4 tiles
